[Overview]
Easy to use script that defeats activation on Windows 10 and Server 2016/2019/2022 on UEFI-GPT systems using SLIC emulation technique.
...
KMS38:
Windows 10/11:
Enterprise, Enterprise LTSC/LTSB, Enterprise G, Enterprise multi-session, Enterprise, Education, Pro, Pro Workstation, Pro Education, Home, Home Single Language, Home China + N editions
...
Q: How to upgrade core editions to non-core editions?
A: Open an admin command prompt.

Check which key you want to install, depending on the edition you want to upgrade to:
...
run this command:
changepk /productkey [enter your key here]
Wait for it to complete, ignore any errors.
